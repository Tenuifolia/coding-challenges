...
// This first example updates all book documents with a new “product type” field to identify the shape of the ebook, 
// printed book, and audiobook documents. The pipeline also adds a product_id field for all documents and makes shared 
// attributes more consistent. It does this by changing desc and details fields to description and by converting the 
// author field to an array. Finally, it replaces the existing documents in the same collection.
...
//   The next pipeline changes all documents with a product type of “unspecified” 
//   with a minute length greater than zero to “audiobook” and saves them to the collection.
